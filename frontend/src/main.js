...
pluralCaseList.push( {plural: "deilveries", pascal: "Deilvery"} )

pluralCaseList.push( {plural: "notifyLogs", pascal: "NotifyLog"} )

pluralCaseList.push( {plural: "myDeliveryInfos", pascal: "MyDeliveryInfo"} )
pluralCaseList.push( {plural: "points", pascal: "Point"} )

pluralCaseList.push( {plural: "pointInfos", pascal: "PointInfo"} )
